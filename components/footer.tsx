          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://www.linkedin.com/company/thailand-prestige/?viewAsMember=true" className="w-10 h-10 rounded-full bg-gray-200 hover:bg-accent hover:text-white flex items-center justify-center transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
